...
RSpec.describe ScansController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: scan.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      scan = Scan.create! valid_attributes
      get :edit, params: {id: scan.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Scan" do
        expect {
          post :create, params: {scan: valid_attributes}, session: valid_session
